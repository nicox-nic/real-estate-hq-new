...
interface ListingDistributionFlowProps {
  role: "Broker" | "Realtor";
}

/**
 * Listing Distribution flow (#41) — parameterized component used by
 * both /broker/listings/[id]/distribute (7B) and
 * /realtor/listings/[id]/distribute (9 polish carry-forward).
 *
 * 8th use of the single-parameterized-component pattern. Same shape
 * as the other 7 (ManagerDashboard, Leaderboard, AgentsModule,
 * AgentProfile, TeamUpdates, AwardsCampaigns, ManagerAnalytics).
 *
 * Role-aware scope: broker sees direct reports; realtor sees transitive
 * network — same teamIds resolution from managerDashboardDerivations.
 *
 ...
 */
export function ListingDistributionFlow({
  role,
