...
export const prdRoutes: PRDRoute[] = [
  ...
  // ----- Dashboards (Session 3 / 7) -----
  {
    ...
    route: "/agent",
    expectedElements: [
      "KPI cards (Hot Leads, Pending Replies, Active Deals, This Month Earnings)",
      "Active deals panel",
  ...
  // ----- Leads & Conversation (Session 3) -----
  {
    ...
    route: "/agent/leads",
    expectedElements: [
      "Filter tabs (Needs Reply / Hot / Warm / Nurture / Cold / All)",
      "Lead source icons",
      "Lead score chip per row",
  ...
  },
  {
    ...
    expectedElements: [
      "Buyer details (budget, timeline, preferences)",
